...
import { NotFoundError, BadRequestError } from "../errors/systemErrors.js";
...
export const handleAddStore = async (req, res, next) => {
  try {
    ...
    //가게 등록시 필수 내용 확인
    if(!req.body.store_name||!req.body.region_name||!req.body.address) throw new RequestError("name, region_name, adress는 필수 입니다.");
